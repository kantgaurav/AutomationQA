...
'Step 4:'
'Create a Pay Elements'
String createdPayElementsName = PayElementsPageSteps.createPayElements()
'ER:'
'Pay Elements is created successfully'
PayElementsPageSteps.getBaseSteps().verifyMainPopUpHasContent("Pay Element Added")
