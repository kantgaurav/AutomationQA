...
ContractDocumentLibraryPageSteps.getBaseSteps().waitForProgressBarDisappear()
'ER:'
'Contract Document modal displays'
ContractDocumentLibraryPageSteps.getBaseSteps().verifyControlContainedTextDisplayed("Modal_Content_Header_Label", String.format("Contract Document - %s",contractDocumentName), PageLocatorName.COMMONLOCATORS_PAGE)
...
ContractDocumentLibraryPageSteps.getBaseSteps().verifyControlContainedTextDisplayed("Tab_Content_Label", "Super Admin", PageLocatorName.CONTRACTDOCUMENTLIBRARY_PAGE)
