...
'Step 5:'
'Create a CAR Approval Setup with Cost Center, Template and Hierachical'
String createdCARApprovalName = CARApprovalSetupPageSteps.createApproval("CAR Approval", "Location", "Hierarchical", 
...
'Step 11:'
'Fist user approves the request'
ViewCARPageSteps.search(createdProvidersName)
...
'Step 12: Second user approves the request'
