...
'Step 5:'
'Create a CAR Approval Setup with Region, Template and Minimum Approver'
String createdCARApprovalName = CARApprovalSetupPageSteps.createApproval("CAR Approval", "Region", "Minimum Approver",
