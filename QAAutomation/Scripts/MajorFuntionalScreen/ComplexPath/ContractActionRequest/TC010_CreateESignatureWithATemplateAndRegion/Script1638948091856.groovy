...
'Step 8: '
'Create a E-Signature Approvals Setup with Region, Template and Hierachical'
MenuPageSteps.selectConntractActionRequestMenu("CAR Approval Setup")
String createdESignApprovalName = CARApprovalSetupPageSteps.createApproval("E-Signature", "Region", "Hierarchical",
...
'Step 17:'
'Open email inbox'
MailTempTopPageSteps.getBaseSteps().setTextToControl("Email_Textbox",GlobalVariable.APPROVER_MAIL_USER1, PageLocatorName.MAILTEMPTOP_PAGE)
...
'The email is sent'
String expectedApprover1EmailContent = String.format("Please DocuSign %s",createdProvidersName)
String mailSubject1 = String.format("Singture Requested - %s",createdProvidersName)
String emailAppr1Content = MailTempTopPageSteps.getContentCARmail(mailSubject1, createdProvidersName)
AssertSteps.verifyExpectedResult(emailAppr1Content.contains(expectedApprover1EmailContent))

'Step 18: Check email of signer 2 send:'
'Open  email'
Browser.navigateToURL(GlobalVariable.MAIL_TEMP_TOP_URL)
'ER:'
'Yop mail is loaded'
MailTempTopPageSteps.getBaseSteps().verifyControlDisplayed("Email_Textbox", PageLocatorName.MAILTEMPTOP_PAGE)
'Open email inbox'
MailTempTopPageSteps.getBaseSteps().setTextToControl("Email_Textbox",GlobalVariable.APPROVER_MAIL_USER2, PageLocatorName.MAILTEMPTOP_PAGE)
MailTempTopPageSteps.getBaseSteps().clickToControl("Create_Button", PageLocatorName.MAILTEMPTOP_PAGE)
'ER:'
'Inbox is loaded'
YopmailPageSteps.getBaseSteps().verifyControlDisplayed("Refresh_Button", PageLocatorName.MAILTEMPTOP_PAGE)
'The email is sent'
String expectedApprover2EmailContent = String.format("Please DocuSign %s",createdProvidersName)
String mailSubject2 = String.format("Singture Requested - %s",createdProvidersName)
String emailAppr2Content = MailTempTopPageSteps.getContentCARmail(mailSubject2, createdProvidersName)
AssertSteps.verifyExpectedResult(emailAppr2Content.contains(expectedApprover2EmailContent))

'Step 19: Check email of send:'
'Open yopmail email'
Browser.navigateToURL(GlobalVariable.MAIL_TEMP_TOP_URL)
'ER:'
'Yop mail is loaded'
MailTempTopPageSteps.getBaseSteps().verifyControlDisplayed("Email_Textbox", PageLocatorName.MAILTEMPTOP_PAGE)
'Open email inbox'
MailTempTopPageSteps.getBaseSteps().setTextToControl("Email_Textbox",GlobalVariable.NOTIFIER_MAIL_USER1, PageLocatorName.MAILTEMPTOP_PAGE)
MailTempTopPageSteps.getBaseSteps().clickToControl("Create_Button", PageLocatorName.MAILTEMPTOP_PAGE)
'ER:'
'Inbox is loaded'
MailTempTopPageSteps.getBaseSteps().verifyControlDisplayed("Refresh_Button", PageLocatorName.MAILTEMPTOP_PAGE)
'The preAction email is sent'
String expectedPreActionEmailContent = String.format("The Contract for %s",createdProvidersName)
String preActionEmailContent = MailTempTopPageSteps.getContentCARmail("Contract Sent for Signing - H II CMS", createdProvidersName)
AssertSteps.verifyExpectedResult(preActionEmailContent.contains(expectedPreActionEmailContent))

//'The postAction email is sent'
//String expectedPosActionEmailContent = String.format("The Contract for %s",createdProvidersName)
//String posActionEmailContent = MailTempTopPageSteps.getContentCARmail("Contract Sent for Signing - H II CMS", createdProvidersName)
