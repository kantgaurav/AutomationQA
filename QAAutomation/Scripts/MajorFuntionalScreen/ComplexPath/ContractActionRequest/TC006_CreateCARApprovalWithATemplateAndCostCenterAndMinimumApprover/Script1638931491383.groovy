...
'Step 5:'
'Create a CAR Approval Setup with Cost Center, Template and Minimum Approver'
String createdCARApprovalName = CARApprovalSetupPageSteps.createApproval("CAR Approval", "Cost Center", "Minimum Approver",
