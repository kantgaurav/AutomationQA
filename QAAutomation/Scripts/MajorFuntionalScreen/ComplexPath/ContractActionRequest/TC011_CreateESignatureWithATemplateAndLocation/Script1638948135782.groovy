...
'Step 8: '
'Create a E-Signature Approvals Setup with Location, Template and Hierachical'
MenuPageSteps.selectConntractActionRequestMenu("CAR Approval Setup")
String createdESignApprovalName = CARApprovalSetupPageSteps.createApproval("E-Signature", "Location", "Hierarchical",
