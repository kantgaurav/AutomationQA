...
'Step 5:'
'Create a CAR Approval Setup with Location, Template and Minimum Approver'
String createdCARApprovalName = CARApprovalSetupPageSteps.createApproval("CAR Approval", "Location", "Minimum Approver",
	createdRegionName, createdLocationName, createdCCName, createdSpecialtyName, createdPositionName, [GlobalVariable.APPROVER_USER1,GlobalVariable.APPROVER_USER2, GlobalVariable.APPROVER_USER3], [GlobalVariable.NOTIFIER_USER1], createdTemplateName,true,true, "2", false)
'ER:'
...
ViewCARPageSteps.verifyNameOfApprover(createdProvidersName, [GlobalVariable.APPROVER_USER1,GlobalVariable.APPROVER_USER2, GlobalVariable.APPROVER_USER3])
'Verify that 2 users have the status = Sent For Approval at Approval Complete column'
ViewCARPageSteps.verifyStatusAtApprovalsCompleteColumn(createdProvidersName, ["Awaiting Approval"], "0/3")

'Step 11:'
'Fist user approval the request'
ViewCARPageSteps.search(createdProvidersName)
...
ViewCARPageSteps.verifyStatusAtApprovalsCompleteColumn(createdProvidersName, ["Approved","Awaiting Approval"], "1/3")
...
ViewCARPageSteps.verifyStatusAtApprovalsCompleteColumn(createdProvidersName, ["Approved","Awaiting Approval"],"2/3")
